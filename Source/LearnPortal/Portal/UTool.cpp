...
FVector FUTool::ConvertLocationToActorSpace(FVector Location, AActor* Reference, AActor* Target)
{
...
FRotator FUTool::ConvertRotationToActorSpace(FRotator Rotation, AActor* Reference, AActor* Target)
{
	if (Reference == nullptr || Target == nullptr)
	{
...
FVector FUTool::ConvertVelocityToActorSpace(FVector Velocity, AActor* Reference, AActor* Target)
{
	if (Reference == nullptr || Target == nullptr)
	{
		return FVector::ZeroVector;
...
FVector FUTool::ConvertCameraLocation(FVector Location, AActor* Reference, AActor* Target)
{
	if (Reference == nullptr || Target == nullptr)
	{
		return FVector::ZeroVector;
